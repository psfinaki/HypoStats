...
class MainViewModelTest {
    ...
    @Test
    fun `initial state should have HYPO tab selected`() =
        runTest {
    ...
    @Test
    fun `initial state should have HOME drawer destination selected`() =
        runTest {
            val state = viewModel.state.value
    ...
    @Test
    fun `selectDrawerDestination should update selected destination`() =
        runTest {
    ...
    @Test
    fun `multiple tab selections should preserve latest state`() =
        runTest {
            viewModel.selectTab(AppTab.STATS)
    ...
    @Test
    fun `multiple drawer selections should preserve latest state`() =
        runTest {
            viewModel.selectDrawerDestination(DrawerDestination.LOG)
